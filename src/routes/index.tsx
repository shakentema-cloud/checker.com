  ...
  return (
    <AppShell>
      <div className="relative isolate overflow-hidden">
        ...
        <section className="bg-background/88 backdrop-blur-[2px] py-32 border-t border-border flex flex-col items-center overflow-hidden">
        ...
        {/* Features */}
        <section className="bg-paper/90 backdrop-blur-[2px] py-32 border-t border-ledger">
          <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-3 gap-12">
            {[
              ...
              <Link key={i} to={c.l} className="dossier bg-card/90 p-10 group hover:border-gold transition-colors block">
